...
const CategoryRegistration = () => {
    ...
    const handleCategorySelect = (category) => {
        ...
        setFormData({
            ...formData,
            items: [{ name: '', price: '', veg: true, category: 'main', image: null }]
        });
    };
    ...
    const addItem = () => {
        setFormData({
            ...formData,
            items: [...formData.items, { name: '', price: '', veg: true, category: 'main', image: null }]
        });
    };
                    ...
                    <div className="hr-header">
                        ...
                        <div className="hr-navigation">
                            ...
                            <button
                                ...
                                disabled={formData.items.length === 0 || formData.items.some(item => !item.image)}
                            >
                                ...
                                <div key={index} className="hr-item-form">
                                    ...
                                    <div className="hr-form-group hr-full-width">
                                        <label className="hr-label">
                                            ...
                                            Food Image <span className="hr-required">*</span>
                                        </label>
